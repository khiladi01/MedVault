...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {/* Sales Poster */}
            <div className="h-[25px] w-full bg-slate-400 flex justify-center items-center select-none">
                <p className="text-slate-800 tracking-wider">MedVault Health Care Center</p>
            </div>
        </>
    );
}
